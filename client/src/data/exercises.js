// Mirror of server exercise library — used as fallback when API is unavailable
...
export const MUSCLE_GROUPS = ['Upper Body', 'Lower Body', 'Full Body'];

export const SUB_FOCUS_MAP = {
  'Upper Body': ['Chest', 'Back', 'Shoulders', 'Arms'],
  'Lower Body': ['Legs'],
  'Full Body': ['Core', 'Full Body'],
};

export function getSubFocusList(muscleGroup) {
  return SUB_FOCUS_MAP[muscleGroup] || [];
}
